...
const String sRules2 =
    "\nObjective: To complete a hand of 14 cards consisting of four sets and a pair. A set can be a sequence of three numerical cards or a triplet of three identical cards. Sequences are called “Chows” and Triplets are called “Pungs”. A pair is called “Eyes”. The winning hand is scored and the first player to reach 500 points wins the game. Setup: A dealer is chosen by lot, the deck is shuffled and each player is dealt 13 cards. The dealer will be the starting playe";
