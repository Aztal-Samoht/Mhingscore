            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  Divider(color: Colors.black, thickness: 2),
                  getBoolPicker([true, false], sHand8, newHand.getTripOnly,
                      newHand.setTripOnly),
                  getNumberPicker([0, 1, 2, 3, 4, 6], sHand9,
                      newHand.getIdentDblSeq, newHand.setIdenDblSeq),
                  getBoolPicker([true, false], sHand10, newHand.getRoyRun,
                      newHand.setRoyRun),
                  getBoolPicker([true, false], sHand11, newHand.getOneSuitHon,
                      newHand.setOneSuitHon),
                  getBoolPicker([true, false], sHand12, newHand.getNoConnect,
                      newHand.setNoConnect),
