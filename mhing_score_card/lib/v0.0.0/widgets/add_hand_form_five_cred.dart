...
import 'package:mhing_score_card/v0.0.0/widgets/add_hand_form_eight_cred.dart';
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  Divider(color: Colors.black, thickness: 2),
                  getBoolPicker([true, false], sHand13, newHand.getHighLow,
                      newHand.setHighLow),
                  getBoolPicker([true, false], sHand14, newHand.getAllSuitsHon,
                      newHand.setAllSuitsHon),
