            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  Divider(color: Colors.black, thickness: 2),
                  getBoolPicker([true, false], sHand15, newHand.getSeqOnly,
                      newHand.setSeqOnly),
                  getBoolPicker([true, false], sHand16, newHand.getSeqOnly,
                      newHand.setSeqOnly),
                  getBoolPicker([true, false], sHand17, newHand.getSeqOnly,
                      newHand.setSeqOnly),
                  MhingButton(
                    height: 50,
                    width: 175,
